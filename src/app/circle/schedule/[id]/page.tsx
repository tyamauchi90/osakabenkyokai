  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      try {
        ...
        if (res.data?.eventDate instanceof Timestamp) {
          form.setValue("eventDate", res.data.eventDate.toDate());
        } else {
      ...
      const handleUpdatePost = async (id: string) => {
        try {
          ...
          const data = {
            ...
            eventDate:
              form.getValues("eventDate") instanceof Date &&
              Timestamp.fromDate(form.getValues("eventDate")), // Date型をTimestamp型に変換
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <div className="flex gap-4">
                ...
                <PrimaryButton handleClick={handleDelete}>削 除</PrimaryButton>
              </div>
            </CardTitle>
            <CardDescription>
              イベント日:
