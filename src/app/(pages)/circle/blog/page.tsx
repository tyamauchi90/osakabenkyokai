...
const BlogPage = () => {
	...
	const [imgUrls, setImgUrls] = useState<string | string[] | undefined>(undefined);
	const [selectedPost, setSelectedPost] = useState<SelectedFacebookPostType | null>(null);
	...
	return (
		<>
			<div className="container my-12">
				...
				<h2 className="text-center text-2xl sm:text-4xl mb-12 tracking-widest">ブログ一覧</h2>
				<motion.ul
					className={`w-full mx-auto space-y-12 ${selectedPost && "overflow-hidden"}`}
					ref={ref}
                            ...
                            <div className="relative w-[70vw] lg:w-[30vw] h-[50vw] lg:h-[30vw]">
                              ...
                              />
											...
											<CardContent className="flex flex-col items-center py-0 lg:flex-1 text-lg mb-4">
												...
												<span className="whitespace-pre-wrap break-words">{limitedMessage}</span>
											</CardContent>
										</Card>
									</DialogTrigger>
				...
				<div className="flex justify-center my-6">
					...
					>
						{isActive ? (
							...
							<Link href="https://www.facebook.com/p/社会人サークル-おおさか勉強会-100064844221955/?paipv=0&eav=AfYozu38gdjZb906RlubCPn20m0e4qEPRkWO8EG0cdsB4pPBF3eD3RVGnpz9PUUA3LE&_rdr">
								続きはFacebookページをご覧ください
							</Link>
						)}
					</Button>
				</div>
