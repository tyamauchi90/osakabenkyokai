...
export async function GET(
  ...
  try {
    ...
    const apiEndpoint = `https://graph.facebook.com/v21.0/${pageId}/feed?fields=message,created_time,full_picture,attachments{media,subattachments,image,src}&since=${Math.floor(
